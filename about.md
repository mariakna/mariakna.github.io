...
Check my [CV](CV_MKorochkina.pdf) for more details.

Info related to my completed projects (pre-registration, scripts, etc) is available at [OSF](https://osf.io/zf8px/).
